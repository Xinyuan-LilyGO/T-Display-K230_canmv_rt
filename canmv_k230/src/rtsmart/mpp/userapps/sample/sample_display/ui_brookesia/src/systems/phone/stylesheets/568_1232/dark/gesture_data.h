...
#define ESP_BROOKESIA_PHONE_568_1232_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA() \
    {                                                                      \
        .main = {                                                          \
...
#define ESP_BROOKESIA_PHONE_568_1232_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA() \
    {                                                                  \
        .main = {                                                      \
