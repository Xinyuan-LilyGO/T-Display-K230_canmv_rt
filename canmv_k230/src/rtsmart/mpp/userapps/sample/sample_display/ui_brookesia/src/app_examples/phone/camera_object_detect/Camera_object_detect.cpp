#include <math.h>
#include <vector>
#include "Camera_object_detect.hpp"
#include "../../../../../cap_vio.h"
#include "object_detect_yolov8n/object_detect.h"
using namespace std;

LV_IMG_DECLARE(img_app_object_detect);
...
Camera_object_detect::Camera_object_detect(bool use_status_bar, bool use_navigation_bar):
    ESP_Brookesia_PhoneApp(
        ESP_BROOKESIA_CORE_APP_DATA_DEFAULT("Object_detect", &img_app_object_detect, true),
        ESP_BROOKESIA_PHONE_APP_DATA_DEFAULT(&img_app_object_detect, use_status_bar, use_navigation_bar)
    )
{
}

Camera_object_detect::~Camera_object_detect()
{

}
int Camera_object_detect::camera_open(int _sensor_type)
{
    ...
    vi_chn_config(dev_num,VICAP_CHN_ID_1,992,560,PIXEL_FORMAT_BGR_888_PLANAR);//add chn for model
...
void Camera_object_detect::camera_close()
 {   
 k_vicap_dev dev_num=VICAP_DEV_ID_0;
 k_s32 chn_num=0;
...
bool Camera_object_detect::run(void)
{
 ...
 */
bool Camera_object_detect::back(void)
{
 ...
 */
bool Camera_object_detect::close(void)
{
 object_detect_stop();
 camera_close();
 /*k_vicap_dev dev_num=VICAP_DEV_ID_0;
...
bool Camera_object_detect::init(void)
{
 ...
 bool Camera_object_detect::pause()
{
...
bool Camera_object_detect::resume()
 {
...
void Camera_object_detect::keyboard_event_cb(lv_event_t *e)
{
}
