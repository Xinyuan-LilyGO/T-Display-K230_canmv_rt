#include <math.h>
#include <vector>
#include "Camera_head_detect.hpp"
#include "../../../../../cap_vio.h"
#include "head_detection/head_detect.h"



using namespace std;

LV_IMG_DECLARE(img_app_head_detect);
...
Camera_head_detect::Camera_head_detect(bool use_status_bar, bool use_navigation_bar):
    ESP_Brookesia_PhoneApp(
        ESP_BROOKESIA_CORE_APP_DATA_DEFAULT("Head_detect", &img_app_head_detect, true),
        ESP_BROOKESIA_PHONE_APP_DATA_DEFAULT(&img_app_head_detect, use_status_bar, use_navigation_bar)
    )
{
}

Camera_head_detect::~Camera_head_detect()
{

}
int Camera_head_detect::camera_open(int _sensor_type)
{
...
void Camera_head_detect::camera_close()
 {   
 k_vicap_dev dev_num=VICAP_DEV_ID_0;
 k_s32 chn_num=0;
...
bool Camera_head_detect::run(void)
{
 ...
 */
bool Camera_head_detect::back(void)
{
 ...
 */
bool Camera_head_detect::close(void)
{
 head_detect_stop();
 camera_close();
 /*k_vicap_dev dev_num=VICAP_DEV_ID_0;
...
bool Camera_head_detect::init(void)
{
...
bool Camera_head_detect::resume()
 {
...
void Camera_head_detect::keyboard_event_cb(lv_event_t *e)
{
}
