...
void ui_ScreenSettingVerification_screen_init(void)
{
    ...
    lv_obj_set_x(ui_LabelScreenSettingVerification, -230);
    ...
    lv_obj_set_x(ui_LabelScreenSettingVerificationSSID, -30);
    ...
    lv_obj_set_width(ui_TextAreaScreenSettingVerificationPassword, 400);
