#include <math.h>
#include <vector>
#include "Camera_face_emotion.hpp"
#include "../../../../../cap_vio.h"
#include "face_emotion/emotion_detect.h"
using namespace std;

LV_IMG_DECLARE(img_app_emotion_detect);
...
Camera_face_emotion::Camera_face_emotion(bool use_status_bar, bool use_navigation_bar):
    ESP_Brookesia_PhoneApp(
        ESP_BROOKESIA_CORE_APP_DATA_DEFAULT("Emo_detect", &img_app_emotion_detect, true),
        ESP_BROOKESIA_PHONE_APP_DATA_DEFAULT(&img_app_emotion_detect, use_status_bar, use_navigation_bar)
    )
{
}

Camera_face_emotion::~Camera_face_emotion()
{

}
int Camera_face_emotion::camera_open(int _sensor_type)
{
...
void Camera_face_emotion::camera_close()
 {   
 k_vicap_dev dev_num=VICAP_DEV_ID_0;
 k_s32 chn_num=0;
...
bool Camera_face_emotion::run(void)
{
 ...
 */
bool Camera_face_emotion::back(void)
{
 ...
 */
bool Camera_face_emotion::close(void)
{
 emotion_detect_stop();
 camera_close();
 /*k_vicap_dev dev_num=VICAP_DEV_ID_0;
...
bool Camera_face_emotion::init(void)
{
 ...
 bool Camera_face_emotion::pause()
{
...
bool Camera_face_emotion::resume()
 {
...
void Camera_face_emotion::keyboard_event_cb(lv_event_t *e)
{
}
