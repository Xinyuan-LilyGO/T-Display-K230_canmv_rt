#ifndef __NETWOTK_RT_OPT_H__
#define __NETWOTK_RT_OPT_H__
...
int get_net_ifconfig(int _net_if,char*ip_addr,char* netmask_addr,char* gw_addr,char* dns_addr); 
int  set_net_ifconfig(int _net_if,char*ip_addr,char* netmask_addr,char* gw_addr,char* dns_addr);
