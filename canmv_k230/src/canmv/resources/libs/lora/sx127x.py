...
from libs.lora.modem import BaseModem, ConfigError, RxPacket, _clamp, _flag
...
class _SX127x(BaseModem):
    ...
    def _read_packet(self, rx_packet, flags):
        ...
        print(f"read_packet:{rx_packet},rx_payload_len:{rx_payload_len}")
    ...
    def prepare_send(self, packet):
        ...
        print(f"prepare send:{packet},len:{len(packet)}")
...
try:
    from libs.lora.sync_modem import SyncModem
